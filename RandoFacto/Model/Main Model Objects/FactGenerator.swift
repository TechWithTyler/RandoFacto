...
struct FactGenerator {
    ...
    var factURLString: String {
        ...
        // HTTPS is on layer 7 of the OSI model, the application layer, which is the topmost layer. The OSI model is a conceptual framework used to understand how different networking protocols interact with each other. The OSI model consists of 7 layers, each representing a different aspect of network communication. The layers are: 1) Physical, 2) Data Link, 3) Network, 4) Transport, 5) Session, 6) Presentation, and 7) Application. Layer 2 is the physical layer, the hardware which connects the device running RandoFacto to the internet, and layer 1 is how the data is transmitted over the internet.
        let scheme = "https"
